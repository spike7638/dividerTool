...
function EditorComponent(Props) {
  ...
  var compXY = function (s1, s2) {
    var dx = Caml_primitive.caml_int_compare(s1.sp.p1.xi, s2.sp.p1.xi);
    var dy = Caml_primitive.caml_int_compare(s1.sp.p1.yi, s2.sp.p1.yi);
    if (dx === 0) {
      return dy;
    } else {
      return dx;
  ...
  var buildGeom = function (s) {
    ...
    var ratio = Caml_primitive.caml_float_min(860 / extendedWidth, 860 / extendedHeight);
  ...
  var drawStrokes = function (state, env) {
    ...
    List.map((function (s) {
            ...
            var p1_0 = Caml_primitive.caml_float_min(match[0], x0);
            var p1_1 = Caml_primitive.caml_float_max(match[1], y0);
            var p1 = [
              p1_0,
              p1_1
            ];
            var match$1 = gToW(state, s.sp.p2);
            var p2_0 = Caml_primitive.caml_float_min(match$1[0], x0);
            var p2_1 = Caml_primitive.caml_float_max(match$1[1], y0);
            var p2 = [
              p2_0,
              p2_1
            ];
